...
class _TeacherAttendanceState extends State<TeacherAttendance> {
  ...
  // DateTime _targetDateTime =  DateTime(2020, 25, 4);
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            FlatButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  _targetDateTime = DateTime(_currentDate2.year,
                            ...
                            FlatButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  _targetDateTime =
                                      // _currentDate2;
                                      // print(this.batchStart);
                                      DateTime(_targetDateTime.year,
